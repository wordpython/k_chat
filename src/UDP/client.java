...
//	}
	client(String username) {
		...
		try {
			...
			sendMessageToServer(address,username,null,9001,"yes");//将客户端本地计算机名发送给服务器
		...
		addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e) {
				...
				sendMessageToServer(address,username,null,9001,"no");
				System.exit(0);
			}
		});
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(message!=null && !message.equals("")) {
			...
			jta2.setText(null);
			sendMessageToServer(address,username,message,9001,"yes");
		}
	}
